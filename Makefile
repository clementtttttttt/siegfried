...
test: sf.iso
	qemu-system-x86_64 -cdrom sf.iso -d cpu_reset,int -drive file=/dev/nvme0n1,if=none,id=nvm -device nvme,serial=deadbeef,drive=nvm -m 6G  -L /usr/share/ovmf/x64 -bios OVMF.fd -smp 3  -cpu host,+x2apic  -enable-kvm
