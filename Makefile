CFLAGS=-Wno-address-of-packed-member  -std=gnu99 -ffreestanding -O2 -Wall -Wextra -g -m64  -mno-red-zone -fno-builtin -fno-builtin-memcpy -nostdlib -static -Werror -Wno-unused-parameter -fno-stack-protector -march=k8 -mtune=k8
ASFLAGS=$(CFLAGS)
