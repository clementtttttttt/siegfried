...
test: iso
	qemu-system-x86_64 -cdrom sf.iso -d cpu_reset,int -drive file=test.img,if=none,id=nvm -device nvme,serial=deadbeef,drive=nvm -m 6G  -L /usr/share/ovmf/x64 -bios OVMF.fd #-cpu host -enable-kvm
