CFLAGS=-Wno-address-of-packed-member -std=gnu99 -ffreestanding -O2 -Wall -Wextra -g -m64  -mno-red-zone  -fno-builtin -nostdlib -static -Werror -Wno-unused-parameter -fno-stack-protector -march=k8 -mtune=k8
ASFLAGS=$(CFLAGS)
...
test: sf.iso
	qemu-system-x86_64 -cdrom sf.iso -d cpu_reset -drive file=test.img,if=none,id=nvm -device nvme,serial=deadbeef,drive=nvm -m 6G  -L /usr/share/edk2-ovmf/ -bios OVMF_CODE.fd -smp 3  -cpu host,+x2apic -enable-kvm
