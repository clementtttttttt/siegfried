...
void* liballoc_alloc(int pgs){
	return page_find_and_alloc(pgs);
}

int liballoc_free(void* addr,int pgs){
	page_free_found((unsigned long)addr, pgs);
	return 0;
...
static int l_pageSize  = 2097152;			//< Individual page size
static unsigned long l_pageCount = 1;			//< Minimum number of pages to allocate.
